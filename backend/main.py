...
if __name__ == "__main__":
    ...
    # Render/Railway set the PORT env var and expect a 0.0.0.0 bind with no
    # reloader. Locally (python main.py with no PORT set), keep the original
    # dev-friendly behaviour: 127.0.0.1:8000 with auto-reload.
    ...
    print(f"Starting CivicMysuru backend on http://{host}:{port}")
